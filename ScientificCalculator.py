...
def history_table():
    ...
    #  Important thing to note here is for the first time we should run the code with commenting out the next line of this comment and later you can uncomment it for rest of time...
    #  Because we have a create a table named History1 for deleting it ..
